...
export const renderMarkdown = (text: string): string => {
  ...
  html = html.replace(/\[(\d+)\]/g, '<button type="button" data-citation-id="$1" class="inline-flex items-center rounded-md border border-indigo-200 bg-indigo-50 px-1.5 py-0.5 text-[0.75rem] leading-none text-indigo-700 align-middle hover:bg-indigo-100 transition-colors">[$1]</button>');
