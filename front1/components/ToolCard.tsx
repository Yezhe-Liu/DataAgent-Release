    ...
    return (
      <div className="my-2">
        <div
          ...
          className="p-3 bg-red-50 border border-red-200 rounded-lg flex items-center gap-3 cursor-pointer hover:bg-red-100 transition-colors"
        >
          <div className="w-4 h-4 rounded-full bg-red-500 flex-shrink-0 mt-0.5" />
          <div className="flex-1">
            <div className="text-sm text-red-700">
              调用失败 <span className="font-medium">{toolName}</span>
            </div>
            {input && Object.keys(input).length > 0 && (
        ...
        {expanded && output && (
          <div className="mt-2 rounded-lg overflow-hidden border border-red-200">
            <div className="bg-red-900 px-3 py-2 text-xs text-red-100 flex items-center justify-between">
              <span>工具错误信息</span>
